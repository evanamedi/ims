...
suppliers_form_list = [
    ...
    ['updateFormID', [
        {'for_label': 'supplier-update-field', 'text': 'Supplier ID:', 'id':'update-id', 'name':'supplier_id', 'type': 'select', 'options': {'': ''}},
    ...
    ['getFormID', [
        {'for_label': 'supplier-id', 'text': '(search) Supplier ID:', 'id': 'get-supplier-id', 'name': 'the-supplier-id', 'type': 'select', 'options': {'': ''}}
    ]],
    
    ['deleteFormID', [
        {'for_label': 'supplier_id', 'text': '(delete) Supplier ID:', 'id': 'delete-supplier-id', 'name': 'the-supplier-id', 'type': 'select', 'options': {'': ''}}
    ]]
]
...
products_form_list = [
    ['createFormID', [
        {'for_label': 'supplier_id', 'text': 'Supplier ID', 'id': 'add_product_supplier_id', 'name': 'add_product_supplier_id', 'type': 'select', 'options': {'': ''}},
    ...
    ['updateFormID', [
        {'for_label': 'product_id', 'text': 'Product ID', 'id': 'update_product_by_id', 'name': 'update_product_id', 'type': 'select', 'options': {'': ''}},
    ...
    ['getFormID', [
        {'for_label': 'product_id', 'text': '(search) Product ID', 'id': 'get_product_by_id', 'name': 'get_product_by_id', 'type': 'select', 'options': {'': ''}}
    ]],
    
    ['deleteFormID', [
        {'for_label': 'product_id', 'text': '(delete) Product ID', 'id': 'delete_product_by_id', 'name': 'delete_product_by_id', 'type': 'select', 'options': {'': ''}}
    ]]
]
...
customers_form_list = [
    ...
    ['updateFormID', [
        {'for_label': 'customer_id', 'text': 'Customer ID', 'id': 'update_customer_by_id', 'name': 'update_customer_by_id', 'type': 'select', 'options': {'': ''}},
    ...
    ['getFormID', [
        {'for_label': 'customer_id', 'text': '(search) Customer ID', 'id': 'get_customer_by_id', 'name': 'get_customer_by_id', 'type': 'select', 'options': {'': ''}}
    ]],
    
    ['deleteFormID', [
        {'for_label': 'customer_id', 'text': '(delete) Customer ID', 'id': 'delete_customer_by_id', 'name': 'delete_customer_by_id', 'type': 'select', 'options': {'': ''}}
    ]]
]
...
orders_form_list = [
    ['createFormID', [
        {'for_label': 'product_id', 'text': 'Product ID', 'id': 'add_order_product_id', 'name': 'add_order_product_id', 'type': 'select', 'options': {'': ''}},
        {'for_label': 'customer_id', 'text': 'Customer ID', 'id': 'add_order_customer_id', 'name': 'add_order_customer_id', 'type': 'select', 'options': {'': ''}},
    ...
    ['updateFormID', [
        {'for_label': 'order_id', 'text': 'Order ID', 'id': 'update_order_by_id', 'name': 'update_order_by_id', 'type': 'select', 'options': {'': ''}},
    ...
    ['getFormID', [
        {'for_label': 'order_id', 'text': '(search) Order ID', 'id': 'get_order_by_id', 'name': 'get_order_by_id', 'type': 'select', 'options': {'': ''}}
    ]],
    
    ['deleteFormID', [
        {'for_label': 'order_id', 'text': '(delete) Order ID', 'id': 'delete_order_by_id', 'name': 'delete_order_by_id', 'type': 'select', 'options': {'': ''}}
    ]]
]
...
sales_form_list = [
    ['createFormID', [
        {'for_label': 'product_id', 'text': 'Product ID', 'id': 'add_sale_product_id', 'name': 'add_sale_product_id', 'type': 'select', 'options': {'': ''}},
        {'for_label': 'customer_id', 'text': 'Customer ID', 'id': 'add_sale_customer_id', 'name': 'add_sale_customer_id', 'type': 'select', 'options': {'': ''}},
    ...
    ['updateFormID', [
        {'for_label': 'sale_id', 'text': 'Sale ID', 'id': 'update_sale_by_id', 'name': 'update_sale_by_id', 'type': 'select', 'options': {'': ''}},
    ...
    ['getFormID', [
        {'for_label': 'sale_id', 'text': '(search) Sale ID', 'id': 'get_sale_by_id', 'name': 'get_sale_by_id', 'type': 'select', 'options': {'': ''}}
    ]],
    
    ['deleteFormID', [
        {'for_label': 'sale_id', 'text': '(delete) Sale ID', 'id': 'delete_sale_by_id', 'name': 'delete_sale_by_id', 'type': 'select', 'options': {'': ''}}
    ]]
]